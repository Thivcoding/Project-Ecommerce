                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="px-4">
                                            <div style="font-size: 11px;" class="py-1 text-center text-light fw-bold w-100 rounded-pill <?= $item['status'] == '1' ? "bg-success" : "bg-secondary"; ?>"><?= $item['status'] == '1' ? "Visible" : "Hidden"; ?></div>
                                        </td>
